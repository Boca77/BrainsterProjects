...
@section('content')
    <div class="card mb-3" style="border-radius: .5rem;">
        <div class="row g-0">
            <div class="col-md-4 p-5 text-center" style="border-top-left-radius: .5rem; border-bottom-left-radius: .5rem;">
        ...
        @foreach ($user->friends as $friend)
            <div class="p-2 row d-flex align-items-center border-bottom">
                ...
                <div class="d-flex justify-content-center align-items-center col-4">
                    <p class="mb-0" class="">{{ $friend->email }}</p>
                </div>
                <div class="col-4 ">
                    <a href="{{ route('user.show', ['user' => $friend->id]) }}" class="btn float-end btn-primary">
                        View Profile
                    </a>
                </div>
            </div>
